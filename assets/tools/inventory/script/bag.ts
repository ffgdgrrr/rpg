...
export class bag extends Component{
    ...
    traverseChildren(){
        ...
        let lnventory:string[]=Object.assign(new Array(),JSON.parse(window.localStorage.getItem('lnventory')))
        lnventory=this.lnventory
        window.localStorage.setItem('lnventory',JSON.stringify(lnventory))
    }
    setDefultPos(){
